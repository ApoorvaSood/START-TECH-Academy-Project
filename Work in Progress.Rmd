...
```{r}
shapiro.test(data$Previous.CTC) #Not normal
shapiro.test(data$Exp..Months.) #Not normally distributed
shapiro.test(data$CTC) #Not normally distributed
shapiro.test(data$Previous.job.changes) #Not Normal
